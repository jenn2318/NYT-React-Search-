...
placeholder="What subject would you like to search"
id="search"
    />
    </div>
...
name="startDate"
className="form-control"
placeholder="Type in a start year to search - only numbers are allowed"
id="start-date"
    />
    </div>
...
name="endDate"
className="form-control"
placeholder="Type in a  end year to search - only numbers are allowed"
id="end-date"
    />
    </div>
